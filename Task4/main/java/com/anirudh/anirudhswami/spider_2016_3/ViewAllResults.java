...
public class ViewAllResults extends AppCompatActivity {
    ...
    String[] comle;
    /*
    String[] comle = {"Anirudh", "Abishek", "Adithya Balaji", "Adithya Suresh", "Adithya PSS", "Adithya R Ganesh", "Adithya R", "Adithya Ganeshan"
            , "Brathindara", "M.P Balaji", "Balaji K", "Kaushik", "Naga Vishnu Prassad", "Madhavan", "Kartik", "Santhanam", "Sudarshan", "Likhil", "Keshav"
            , "Christopher Nolan", "Diamond", "Eachu", "Friend", "Ganesha", "Venkatesh", "shivram", "Thejas", "Sai Anurudh Reddy", "Hariharan", "India"
            , "Joker", "London", "Orange", "Pranav Chandran", "C Pranav", "Query", "Raj", "Prashant", "Understand", "Vignesh", "Wasp", "Xylophone"
            , "Yashomithra", "Zebra"
    };
    */
    ...
    private DbHelper getHelper() {
        if (anidb == null) {
            anidb = OpenHelperManager.getHelper(this, DbHelper.class);
        }
        return anidb;
    }
    ...
    private Observer<TextViewTextChangeEvent> getSearchObserver() {
        return new Observer<TextViewTextChangeEvent>() {
            ...
            public void onCompleted() {
                Toast.makeText(ViewAllResults.this, "Completed", Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onError(Throwable e) {
                Toast.makeText(ViewAllResults.this, "Error: " + e.getMessage(), Toast.LENGTH_SHORT).show();
            }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_view_all_results, menu);
        return true;
    }
            ...
            case R.id.Search:
                if (!searched) {
                    ...
                    if (reactHere.getText().toString().equals("")) {
                        searched = false;
                        Toast.makeText(ViewAllResults.this, "No Prompt entered to search", Toast.LENGTH_SHORT).show();
                        reactHere.setVisibility(View.INVISIBLE);
                    } else {
                        //Search
                        searched = false;
                        String query = reactHere.getText().toString();
                        Toast.makeText(ViewAllResults.this, "Searching for " + query, Toast.LENGTH_SHORT).show();
                        List<MovieRow> movi = getSingleMovie(query);
                        if (movi.size() == 0) {
                            Toast.makeText(ViewAllResults.this, "Movie " + query + " does not exist in the database", Toast.LENGTH_SHORT).show();
                        } else {
